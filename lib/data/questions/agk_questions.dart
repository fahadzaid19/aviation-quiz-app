...
class AgkQuestions {
  static List<Question> getQuestions() {
    return [
      ...
      Question(
        question: 'The following figures appear on an aeroplane deviation card:',
        options: [
      ...
      Question(
        ...
        options: [
          ...
          '215?',
          'TM-Editor',
          '020-Aircraft General Knowledge  A .LTM',
          '25.04.2016',
          'Seite 2',
        ],
        correctAnswer: 0,
      ...
      Question(
        question: 'A compass is swing using the Relative bearing method. The magnetic Bearing of a distant object is 210?(M) COMPASS HEADING 359                               208 090                                        121 179 272                                         301 RELATIVE BEARING 032 Co-eff A, B and C are:',
        options: [
          'A = - 0.5                  B = + 2               C = + 2',
          'A = + 0.5                 B = + 1                C = - 2',
          'A = - 0.5                  B = + 1                C = + 2',
      ...
      Question(
        question: 'A direct reading magnetic compass shows: Co-eff A= -2, Co-eff. B = + 2 and Co-eff C = +3.',
        options: [
      ...
      Question(
        question: 'The QFE at aerodrome (elevation) 1790 feet is 962 hPa and the QNH 1022 hPa.',
        options: [
      ...
      Question(
        question: 'A direct reading magnetic compass has coefficients A, B and C only.',
        options: [
      ...
      Question(
        question: 'Co-eff B is negative and one third the value of Co-eff. C which is positive.',
        options: [
      ...
      Question(
        question: 'A direct reading magnetic compass is affected by coefficient B and C only,',
        options: [
      ...
      Question(
        question: 'The indications on a directional gyroscope are subject to errors. The most significant are:',
        options: [
      ...
      Question(
        question: 'The advantages of fly-by-wire control are:',
        options: [
      ...
      Question(
        question: 'Hydraulic fluids must have the following characteristics:',
        options: [
          '1. thermal stability',
      ...
      Question(
        question: 'In a hydraulic braking system, an accumulator is pre-charged to 1200 psi.',
        options: [
      ...
      Question(
        question: 'The blade angle of a constant-speed propeller increases with increasing true air speed.',
        options: [
      ...
      Question(
        question: 'A propeller blade is twisted, so as to keep the local Angle of Attack constant along the blade.',
        options: [
      ...
      Question(
        question: 'In case of engine failure during flight the blades of a constant speed propeller in a single engine aeroplane, not fitted with feathering system move in the lowest pitch position by the centrifugal force and/or the spring force.',
        options: [
      ...
      Question(
        question: 'The purpose of the cabin pressure controller, in the automatic mode, is to perform the following functions:',
        options: [
      ...
      Question(
        question: '020-002.jpg In a pressurized aircraft whose cabin altitude is 8000 ft, a crack in a cabin window makes it necessary to reduce the differential pressure to 5 psi.',
        options: [
      ...
      Question(
        question: 'The gyroscope of a turn indicator has:',
        options: [
      ...
      Question(
        question: 'The fields affecting a magnetic compass originate from:',
        options: [
          '1. magnetic masses',
      ...
      Question(
        question: 'Shimmy occurs on the nose wheel landing gear during taxiing when:',
        options: [
      ...
      Question(
        question: 'During descent, the total pressure probe of the airspeed indicator becomes blocked. In this case:',
        options: [
      ...
      Question(
        question: 'The artificial horizon uses a gyroscope with:',
        options: [
      ...
      Question(
        question: 'The characteristics of the directional gyro used in a gyro stabilised compass system are:',
        options: [
          'NB: the degree(s) of freedom of a gyro does not take into account its rotor',
          'spin axis.',
      ...
      Question(
        question: 'A turbo compressor air conditioning system (bootstrap system) includes two heat exchangers; the primary exchanger (P) and the secondary exchanger (S).',
        options: [
      ...
      Question(
        question: 'A mixture setting richer than best power has to be used during climb segments. This results in a lower cylinder head temperature.',
        options: [
          'higher efficiency.',
          'increase of power.',
          'higher torque.',
      ...
      Question(
        question: 'During a deceleration phase at constant attitude, the control system of the artificial horizon results in the horizon bar indicating a nose down attitude.',
        options: [
          'nose up attitude.',
          'constant attitude.',
      ...
      Question(
        question: 'Under normal operating conditions, when an aircraft is in a banked turn, the rate-of-turn indicator indicates:',
        options: [
      ...
      Question(
        question: 'The ice protection system currently used for the most modern jet aeroplanes is the Hot air system.',
        options: [
      ...
      Question(
        question: 'During flight, the wing anti-ice system has to protect a part of the whole leading edge.',
        options: [
      ...
      Question(
        question: 'In jet aeroplanes the \'thermal anti-ice system\' is primarily supplied by bleed air from the engines.',
        options: [
          'turbo compressors.',
      ...
      Question(
        question: 'The ice protection for propellers of modern turboprop aeroplanes works electrically.',
        options: [
          'pneumatically.',
          'with hot air.',
      ...
      Question(
        question: 'The crank assembly consists of crankshaft, connecting rods and pistons.',
        options: [
      ...
      Question(
        question: 'The fuel tanks of aircrafts must be checked for water before the first flight of the day or after a long turnaround time.',
        options: [
      ...
      Question(
        question: 'The task of the primer pump is to provide additional fuel for an engine start.',
        options: [
      ...
      Question(
        question: 'Viscosity is the resistance of a gas or liquid to flow.',
        options: [
      ...
      Question(
        question: 'Consider the flight deck oxygen supply system. The purpose of the oxygen regulator (as a function of demand and altitude) is to:',
        options: [
      ...
      Question(
        question: 'The useful work area in an ideal Otto engine indicator diagram is enclosed by the following gas state change lines 2 adiabatic and 2 isochoric lines.',
        options: [
      ...
      Question(
        question: 'In flight, with centre tank empty and APU operating, a fuel unbalance is detected (quantity in tank 1 < quantity in tank 2).',
        options: [
      ...
      Question(
        question: 'Consider a jet engine whose control is based on the Engine Pressure Ratio (EPR):',
        options: [
      ...
      Question(
        question: 'The cylinder head and oil temperature gauges are to exceed the normal',
        options: [
      ...
      Question(
        question: 'Consider the variable-pitch propeller of a turbo-prop.',
        options: [
          'During deceleration:',
      ...
      Question(
        question: 'Among the different types of aircraft structures, the shell structures efficiently transmit the:',
        options: [
      ...
      Question(
        question: 'The application of carburettor heat reduces the density of air entering the carburettor, thus enriching the fuel/air mixture the volume of air entering the carburettor, thus leaning the fuel/air mixture it reduces the density of air entering the carburettor, thus leaning the fuel/air mixture the volume of air entering the carburettor, thus enriching the fuel/air mixture.',
        options: [
          'TM-Editor',
          '020-Aircraft General Knowledge  A .LTM',
          '25.04.2016',
      ...
      Question(
        question: 'An impulse coupling does not function at such speeds above those encountered in starting. Its engaging pawls are prevented from operating at higher speeds by centrifugal force engine oil pressure a coil spring electro-magnetic action of operating magneto.',
        options: [
          'TM-Editor',
          '020-Aircraft General Knowledge  A .LTM',
          '25.04.2016',
      ...
      Question(
        question: 'The modern anti-skid processes are based on the use of a computer whose input data is:',
        options: [
      ...
      Question(
        question: 'A condenser in parallel with breaker points will intensify current in secondary winding permit arcing across points assist in negative feedback to secondary coil assist in collapse of secondary winding.',
        options: [
          'TM-Editor',
          '020-Aircraft General Knowledge  A .LTM',
          '25.04.2016',
      ...
      Question(
        question: 'If the ground wire between the magneto and the ignition switch becomes disconnected, the most noticeable result will be that the engine cannot be shut down by turning the switch to the OFF position.',
        options: [
      ...
      Question(
        question: 'Aircraft magneto`s receive electrical energy from rotating permanent magneto\'s.',
        options: [
          'batteries',
          'generators',
          'condensers',
      ...
      Question(
        question: 'The crash/fire axe is part of the safety equipment fitted to passenger aircraft.',
        options: [
          'Its function is to:',
      ...
      Question(
        question: 'The altimeter consists of one or several aneroid capsules located in a sealed casing.',
        options: [
      ...
      Question(
        question: 'The most significant advantages of an air data computer (ADC) are:',
        options: [
      ...
      Question(
        question: 'During the approach, a crew reads on the radio altimeter the value of 650 ft.',
        options: [
      ...
      Question(
        question: 'The rate of turn indicator uses a gyroscope:',
        options: [
      ...
      Question(
        question: 'In a transport airplane, an autopilot comprises, in addition to the mode display devices, the following fundamental elements:',
        options: [
          '1- Airflow valve',
          '2- Sensors',
          '3- Comparators',
      ...
      Question(
        question: 'Assume a constant speed DC generator providing a constant output voltage.',
        options: [
      ...
      Question(
        question: 'The angle of attack transmitter placed laterally on the forward part of the fuselage supplies an electrical signal which can indicate the angular position of:',
        options: [
      ...
      Question(
        question: 'The advantages of single-phase A.C. generator tachometer are:',
        options: [
      ...
      Question(
        question: 'The purpose of a battery control unit is generally to isolate the battery:',
        options: [
      ...
      Question(
        question: 'Maximum power output and low mass of aeroplane hydraulic systems can be achieved with high system pressure and low volume flow.',
        options: [
      ...
      Question(
        question: 'Concerning the sequential pneumatic impulses used in certain leading edge de-icing devices, one can affirm that:',
        options: [
      ...
      Question(
        question: 'The accumulator in a hydraulic system works as an energy storage.',
        options: [
          'a fluid storage.',
          'a volume storage.',
          'a pressure storage.',
      ...
      Question(
        question: 'On a normally aspirated engine (non turbo-charged), the manifold pressure gauge always indicates… a lower value than atmospheric pressure when the engine is running.',
        options: [
      ...
      Question(
        question: 'A gaseous sensor/responder tube fire sensor is tested by heating up the sensor with test power connection.',
        options: [
      ...
      Question(
        question: 'The connection in parallel of two 12 volt/ 40 amp hours batteries, will create a',
        options: [
      ...
      Question(
        question: 'The mechanism to change the propeller blade pitch of modern small piston engine aeroplanes is operated hydraulically by engine oil.',
        options: [
      ...
      Question(
        question: 'A directional gyro is:',
        options: [
      ...
      Question(
        question: 'A turn indicator is an instrument which indicates rate of turn.',
        options: [
      ...
      Question(
        question: 'The heading read on the dial of a directional gyro is subject to errors, one of which is due to the movement of the aircraft.',
        options: [
          'This error...',
      ...
      Question(
        question: 'Which of the following statements are correct for an aeroplane cruising at FL 60 with a true airspeed (TAS) of 100 kt in standard atmospheric conditions?',
        options: [
      ...
      Question(
        question: 'The contents of an oxygen bottle can be ensure by the:',
        options: [
          '1 - weight.',
          '2 - pressure.',
          '3 - level.',
      ...
      Question(
        question: 'Command bars of the flight director may be present on the:',
        options: [
          '1 - HSI',
          '2 - EICAS',
          '3 - CDU',
      ...
      Question(
        question: 'Gas turbine engine rotational speed (RPM) is usually sensed using either a 3 phase AC tachometer generator or an AC phonic wheel system.',
        options: [
      ...
      Question(
        question: 'Equivalent Air Speed (EAS) is obtained from Indicated Air Speed (IAS) by correcting for the following errors:',
        options: [
          '1 - instrument',
          '2 - position',
          '3 - density',
      ...
      Question(
        question: 'True Air Speed (TAS) is obtained from Calibrated Air Speed (CAS) by correcting for the following errors:',
        options: [
          '1 - instrument',
          '2 - compressibility',
          '3 - position',
      ...
      Question(
        question: 'True Air Speed (TAS) is obtained from Indicated Air Speed (IAS) by correcting for the following errors:',
        options: [
          '1 - instrument',
          '2 - position',
          '3 - compressibility',
      ...
      Question(
        question: 'Calibrated Air Speed (CAS) is obtained from Indicated Air Speed (IAS) by correcting for the following errors:',
        options: [
          '1 - position',
          '2 - compressibility',
          '3 - instrument',
      ...
      Question(
        question: 'Equivalent Air Speed (EAS) is obtained from Calibrated Air Speed (CAS) by correcting for the following errors:',
        options: [
          '1 - position',
          '2 - compressibility',
          '3 - instrument',
      ...
      Question(
        question: 'When climbing at a constant RAS in a standard atmosphere:',
        options: [
          '1 - TAS decreases',
          '2 - TAS increases',
      ...
      Question(
        question: 'When descending at a constant RAS in a standard atmosphere:',
        options: [
          '1 - TAS increases',
          '2 - TAS decreases',
          '3 - Mach number increases',
      ...
      Question(
        question: 'If a manifold pressure gauge consistently registers atmospheric pressure, the cause is probably; leak in pressure gauge line.',
        options: [
      ...
      Question(
        question: 'In the hydraulic press schematically shown, what balancing Force would be acting on the right hand side ? (The diagram is not to scale) 100 N.',
        options: [
          '1000 N.',
          '20 N.',
          '1 N.',
      ...
      Question(
        question: 'To allow for failure of the normal method of system pressure limiting control, a hydraulic system often incorporates a high pressure relief valve.',
        options: [
      ...
      Question(
        question: 'Dual ignition provides a factor of safety and improves combustion.',
        options: [
      ...
      Question(
        question: 'An aircraft magneto is switched off by grounding the primary circuit opening the primary circuit opening the secondary circuit grounding the secondary circuit.',
        options: [
          'TM-Editor',
          '020-Aircraft General Knowledge  A .LTM',
          '25.04.2016',
      ...
      Question(
        question: 'A Constant Speed Drive aims at ensuring that the electric generator produces a constant frequency.',
        options: [
      ...
      Question(
        question: 'The reason for the fact that an aeroplane designed for long distances cannot simply be used for short haul flights at higher frequencies is that the lifetime of the fatigue sensitive parts has been based on a determined load spectrum the procedures and checklists for this kind of aeroplanes will take too much time these aeroplanes often consume too much fuel on short haul flights.',
        options: [
      ...
      Question(
        question: 'The part of the flight that will cause the highest loads on the torsion link in a bogie gear is Taxiing with a small turning radius.',
        options: [
      ...
      Question(
        question: 'The reason for the trim switch on a control column to consist of two separate switches is To reduce the probability of a trim-runaway To prevent that both pilots perform opposite trim inputs.',
        options: [
      ...
      Question(
        question: 'The function of a fusible plug is to protect the tyre against explosion due to excessive temperature.',
        options: [
      ...
      Question(
        question: 'Different pressure sensors are used according to the intensity of the pressure measured (low, medium or high) Classify the following sensors by order of increasing pressure for which they are suitable:',
        options: [
          '1- bellows type',
          '2- Bourdon tube type',
      ...
      Question(
        question: 'The indication of a fuel float gauge varies with:',
        options: [
          '1- aircraft attitude',
          '2- accelerations',
      ...
      Question(
        question: 'One of the errors inherent in a ring laser gyroscope occurs at low input',
        options: [
      ...
      Question(
        question: 'The functions of the altitude alerting system is to alert the flight crew:',
        options: [
      ...
      Question(
        question: 'Oxygen systems on pressurized airplanes are used to provide oxygen:',
        options: [
      ...
      Question(
        question: 'The opening of the doors giving access to the oxygen masks for the passengers is:',
        options: [
      ...
      Question(
        question: 'In an inertial reference system (IRS), the alignment sequence consists in:',
        options: [
      ...
      Question(
        question: 'The mode selector of an inertial unit comprises the OFF - STBY - ALIGN - NAV - ATT positions:',
        options: [
      ...
      Question(
        question: 'The CVR (Cockpit Voice Recorder) includes:',
        options: [
          '1. a microphone',
      ...
      Question(
        question: 'The automatic synchronisation function of an autopilot control system:',
        options: [
      ...
      Question(
        question: 'The smoke detection in the aircraft cargo compartments is carried out by four sensors: C1, C2, C3 and C4.',
        options: [
      ...
      Question(
        question: 'The disadvantages of an "electric" fuel (float) gauge are:',
        options: [
      ...
      Question(
        question: 'An automatic landing system necessitating that the landing be continued',
        options: [
      ...
      Question(
        question: 'An "altitude warning system" must at least warn the crew:',
        options: [
      ...
      Question(
        question: 'Among the following functions of an autopilot, those related to the airplane guidance are:',
        options: [
          '1- pitch attitude holding',
          '2- horizontal wing holding',
      ...
      Question(
        question: 'The calculator combined with the stick shaker system of a modern transport airplane receives information about the:',
        options: [
          '1- angle of attack',
          '2- engine R.P.M.',
          '3- configuration',
      ...
      Question(
        question: 'The TCAS 2 data display devices can be in the form of:',
        options: [
      ...
      Question(
        question: 'The electric float gauge:',
        options: [
      ...
      Question(
        question: 'The automatic pitch trim:',
        options: [
      ...
      Question(
        question: 'The disadvantages of axial flow compressors compared to centrifugal flow compressors are:',
        options: [
      ...
      Question(
        question: 'Compared to a tyre fitted with an inner tube, a tubeless tyre presents the following characteristics:',
        options: [
          '1 - high heating',
          '2 - valve fragility',
      ...
      Question(
        question: 'In very cold weather, the pilot notices during startup, a slightly higher than normal engine oil pressure.',
        options: [
      ...
      Question(
        question: 'An oxygen regulator has 3 controls:',
        options: [
      ...
      Question(
        question: 'The control of free turbine engines on turboprops, is accomplished by:',
        options: [
      ...
      Question(
        question: 'The static thrust of a turbo-jet, at the selection of full power:',
        options: [
      ...
      Question(
        question: 'The use of igniters is necessary or recommended on a turbo-jet:',
        options: [
      ...
      Question(
        question: 'In a helicopter automatic flight control system (AFCS), artificial feel is usually achieved by the use of spring boxes or spring units.',
        options: [
      ...
      Question(
        question: 'The auto-throttles enables to hold:',
        options: [
          '1 - a true airspeed;',
          '2 - a Mach number;',
      ...
      Question(
        question: 'The parameters taken into account by the flight director computer in the altitude holding mode (ALT HOLD)  are:',
        options: [
      ...
      Question(
        question: 'The compressibility correction to CAS to give EAS:',
        options: [
          '1 - may be positive',
