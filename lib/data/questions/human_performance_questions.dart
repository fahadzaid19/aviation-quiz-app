...
class HumanPerformanceQuestions {
  static List<Question> getQuestions() {
    return [
      ...
      Question(
        question: 'Performance can be affected by fatigue and lack of motivation. This situation',
        options: [
          'can lead to',
          'over response',
          'under response',
      ...
      Question(
        question: 'Inhaling carbon monoxide can be extremely dangerous during flying.',
        options: [
      ...
      Question(
        question: 'Hypothermia can cause heat stress. The best way to minimize the condition is',
        options: [
          'to',
      ...
      Question(
        question: 'It is quite normal for aircrew to suffer…………………….. in air conditioned/',
        options: [
      ...
      Question(
        question: 'Persons who suffer from tinnitus often have difficulty in falling asleep. This is',
        options: [
          'because',
      ...
      Question(
        question: 'What event can cause a hyperventilation (not required by physical need)?',
        options: [
      ...
      Question(
        question: 'Which of the following could a pilot experience when he is hyperventilating?',
        options: [
          '1. Dizziness',
          '2. Muscular spasms',
      ...
      Question(
        question: 'A pilot who is hyperventilating for a prolonged period of time may even become unconscious.',
        options: [
      ...
      Question(
        question: 'The time between inadequate oxygen supply and incapacitation is called TUC',
        options: [
      ...
      Question(
        question: 'Flights immediately after SCUBA-diving (compressed gas mixtures, bottles)',
        options: [
          '(>10 m depth)',
          'are forbidden',
      ...
      Question(
        question: 'You suffered a rapid decompression without the appearance of any decompression sickness symptoms.',
        options: [
      ...
      Question(
        question: 'Even at normal cabin altitudes (i.e. around 8000 ft) you can get severe abdominal pain and flatulence after eating gas forming foods or fizzy drinks.',
        options: [
      ...
      Question(
        question: 'Trapped intestinal gases can cause severe pain.',
        options: [
      ...
      Question(
        question: 'The proprioceptive senses (seat-of-the-pants sense) are important for motor coordination.',
        options: [
          'They',
      ...
      Question(
        question: 'Orientation in flight is accomplished by',
        options: [
          '1. eyes',
      ...
      Question(
        question: 'The impression of an apparent movement of light when stared at for a',
        options: [
      ...
      Question(
        question: 'Which problem may occur, when flying in an environment of low contrast (fog, snow, darkness, haze)?',
        options: [
      ...
      Question(
        question: 'A pilot approaching an upsloping runway may feel that he is higher than actual. This illusion may cause him to land short.',
        options: [
      ...
      Question(
        question: 'A pilot approaching a runway which is narrower than normal may feel he is at',
        options: [
      ...
      Question(
        question: 'When assessing an individual\'s risk of developing coronary artery disease, the following factors may contribute:',
        options: [
          '1.obesity',
          '2.chronic stress',
          '3.smoking',
      ...
      Question(
        question: 'In order to completely resynchronise with local time after zone crossing,',
        options: [
      ...
      Question(
        question: 'How can a pilot overcome vertigo, encountered during a real or simulated instrument flight?',
        options: [
      ...
      Question(
        question: 'Dizziness and tumbling sensations, when making head movements in a tight',
        options: [
      ...
      Question(
        question: 'What do you do, when you are affected by \"pilot`s vertigo\"?',
        options: [
          '1. Establish and maintain an effective instrument cross-check.',
      ...
      Question(
        question: 'Which flight-manoeuvre will most likely induce vertigo? Turning the head',
        options: [
          'while',
          'banking',
          'climbing',
      ...
      Question(
        question: 'Without visual reference, what illusion could the pilot get, when he is',
        options: [
      ...
      Question(
        question: 'Which of the following symptoms may a pilot experience when subjected to hypoxia?',
        options: [
          '1. Fatigue.',
          '2. Euphoria.',
      ...
      Question(
        question: 'Pilots should not take antihistamines because they may cause:',
        options: [
      ...
      Question(
        question: 'The consumption of medicines or other substances may have consequences on qualification to fly for the following reasons:',
        options: [
      ...
      Question(
        question: 'Vitamin A and possibly vitamins B and C are chemical factors and essential to good night vision:',
        options: [
      ...
      Question(
        question: 'A pilot who smokes will lose some of his capacity to transport oxygen combined with haemoglobin.',
        options: [
      ...
      Question(
        question: 'Flying at pressure altitude of 10 000 ft, a pilot, being a moderate to heavy',
        options: [
      ...
      Question(
        question: 'One of the first effects to be noticed on gradual exposure to high positive',
        options: [
      ...
      Question(
        question: 'When flying at night the first sense to be affected by a slight degree of',
        options: [
          'hypoxia is the',
          'vision',
          'cochlea',
      ...
      Question(
        question: 'The carcinogen (a substance with the ability to produce modifications in cells',
        options: [
      ...
      Question(
        question: 'Altitude-hypoxia, when breathing ambient air, should not usually occur',
        options: [
          '(indifferent phase)',
          'below 3 000 m',
          'up to 5 000 m',
      ...
      Question(
        question: 'The process of responding to a sender by confirming the reception of a',
        options: [
          'message is called',
          'feedback',
          'redundancy',
      ...
      Question(
        question: '\'Environmental capture\' is a term used to describe which of the following statements?',
        options: [
      ...
      Question(
        question: 'A high degree of cockpit automation may alter the traditional tasks of the',
        options: [
      ...
      Question(
        question: 'It is desirable to standardize as many patterns of behaviour (operating',
        options: [
      ...
      Question(
        question: 'Once a pilot has developed a certain way of thinking about a problem he will',
        options: [
          'probably',
      ...
      Question(
        question: 'To maintain good situational awareness you should:',
        options: [
      ...
      Question(
        question: 'Mark the two most important attributes for a positive leadership style:',
        options: [
      ...
      Question(
        question: 'The physiological rhythms of a pilot in a new time zone will resynchronise to',
        options: [
      ...
      Question(
        question: 'The behavioural effects of stress may include:',
        options: [
      ...
      Question(
        question: 'The cognitive effects of stress may include:',
        options: [
          '-1: excessive haste.',
      ...
      Question(
        question: 'What is the effect of stress on performance ?',
        options: [
      ...
      Question(
        question: 'What are the characteristics of the alarm phase of the stress reactions?',
        options: [
      ...
      Question(
        question: 'Which of the following physical stimuli may cause stress reactions?',
        options: [
          '-1: noise.',
          '-2: conflict.',
          '-3: temperature.',
      ...
      Question(
        question: 'Of the following statements, which apply to coordinated cooperation?',
        options: [
      ...
      Question(
        question: 'In order to make communication effective, it is necessary to:',
        options: [
      ...
      Question(
        question: 'Which of the following statements regarding interpersonal interactions are correct?',
        options: [
      ...
      Question(
        question: 'Professional languages have certain characteristics, for example:',
        options: [
      ...
      Question(
        question: 'What are the communication qualities of a good briefing?',
        options: [
      ...
      Question(
        question: 'Which of the following statements are correct with regard to the design of a check list?',
        options: [
      ...
      Question(
        question: 'In order to overcome an overload of work during the flight, it is necessary to:',
        options: [
      ...
      Question(
        question: 'Which of the following statements best fits the definition of an active error?',
        options: [
          'Active error is:',
      ...
      Question(
        question: 'What are the main consequences of latent errors? They:',
        options: [
      ...
      Question(
        question: 'Which of the following statements fits best the concept of latent error?',
        options: [
          'Latent errors:',
      ...
      Question(
        question: 'To avoid wrong decisions by the pilot, an aircraft system should at the',
        options: [
          'minimum to',
      ...
      Question(
        question: 'When can a system be said to be tolerant to error?',
        options: [
          'When:',
      ...
      Question(
        question: 'Why must flight safety considerations consider the human error mechanism?',
        options: [
      ...
      Question(
        question: 'What strategies can be used to combat human error?',
        options: [
      ...
      Question(
        question: 'Stress is a frequent aspect of the pilot\'s job. Under which of the following circumstances does it occur?',
        options: [
      ...
      Question(
        question: 'Divided attention is the ability:',
        options: [
      ...
      Question(
        question: 'In order to get rid of excess nitrogen following scuba diving, subsequent',
        options: [
      ...
      Question(
        question: 'Which of the following human error rates can be described and pretty good',
        options: [
      ...
      Question(
        question: 'The errors resulting from an illogical indexing system in an operations',
        options: [
      ...
      Question(
        question: 'Situations particularly vulnerable to \"reversion to an earlier behaviour pattern\" are:',
        options: [
      ...
      Question(
        question: 'Which of the following operations are performed more effectively by people than by automatic systems ?',
        options: [
      ...
      Question(
        question: 'Which of the following drawbacks are associated with automation ?',
        options: [
      ...
      Question(
        question: 'Which of the following are the most favourable solutions to manage phases of reduced or low vigilance (hypovigilance)?',
        options: [
      ...
      Question(
        question: 'What are main signs indicating the loss of vigilance ?',
        options: [
      ...
      Question(
        question: 'Which of the following statements concerning hypovigilance is correct ?',
        options: [
          'Hypovigilance:',
      ...
      Question(
        question: 'What are the main factors which bring about reduced or low vigilance (hypovigilance) ?',
        options: [
      ...
      Question(
        question: 'Concerning circadian rhythm disruption (jet lag), adjustment to destination time:',
        options: [
      ...
      Question(
        question: 'Which of the following are strategies for resolving conflict?',
        options: [
      ...
      Question(
        question: 'Which of the following statements best characterise a synergetic cockpit?',
        options: [
      ...
      Question(
        question: 'What optimises crew co-operation ?',
        options: [
      ...
      Question(
        question: 'Which of the following elements make up the personality of an individual ?',
        options: [
          '1. Heredity',
      ...
      Question(
        question: 'Which biases relate to human decision making?',
        options: [
      ...
      Question(
        question: 'What are the main characteristics of active errors ?',
        options: [
          'They:',
      ...
      Question(
        question: 'What are the main limits of short-term memory ?',
        options: [
          'It is:',
      ...
      Question(
        question: 'A pilot becomes skilled when he/she:',
        options: [
      ...
      Question(
        question: 'Man possesses a system for maintaining his internal equilibrium in the face of variations brought about by external stimulations.',
        options: [
      ...
      Question(
        question: 'General Adaptation Syndrome is characterised by the following phases:',
        options: [
          '-1: alarm',
          '-2: alert phase',
          '-3: resistance phase',
      ...
      Question(
        question: 'The following course of action should be taken if gastrointestinal complaints in flight crew occur before to take-off:',
        options: [
      ...
      Question(
        question: 'Which of the following systems are involved in motion sickness ?',
        options: [
          '-1: Hearing',
      ...
      Question(
        question: 'Which of the following illusions are brought about by conflicts between the visual system and the vestibular system ?',
        options: [
      ...
      Question(
        question: 'The vestibular system is composed of',
        options: [
          '-1: two ventricles',
          '-2: a saccule',
          '-3: a utricle',
      ...
      Question(
        question: 'In order to perceive colour vision, it is necessary:',
        options: [
      ...
      Question(
        question: 'In civil air transport, linear accelerations (Gx):',
        options: [
          '- 1: do not exist',
      ...
      Question(
        question: 'With regard to the humidity of air in current in a pressurized cabin, we know that it:',
        options: [
      ...
      Question(
        question: 'Which of the following mechanisms regulate body temperature when exposed to extreme high environmental temperatures?',
        options: [
          '-1: Shivering',
      ...
      Question(
        question: 'The Time of Useful Consciousness may vary according to:',
        options: [
      ...
      Question(
        question: 'Of the following alternatives, which effects are due to positive acceleration (+ Gz)?',
        options: [
      ...
      Question(
        question: 'To optimise one\'s night-vision performance, it is necessary:',
        options: [
      ...
      Question(
        question: 'Which of the following characteristics apply to short-term memory ?',
        options: [
      ...
      Question(
        question: 'With regard to central vision, which of the following statements are correct ?',
        options: [
      ...
      Question(
        question: 'Which of the following statements about long-term memory are correct?',
        options: [
      ...
      Question(
        question: 'The atmospheric pressure at 18,000 feet altitude is half the atmospheric pressure at sea level.',
        options: [
      ...
      Question(
        question: 'Our body takes its energy from:',
        options: [
          '1:   minerals',
          '2:   protein',
          '3:   carbonhydrates',
      ...
      Question(
        question: 'The circulatory system, amongst other things, allows for:',
        options: [
      ...
      Question(
        question: 'Blood-pressure depends on:',
        options: [
      ...
      Question(
        question: 'The blood-pressure depends on:',
        options: [
      ...
      Question(
        question: 'When the pressoreceptors signal a lowering of the blood-pressure there are adaptation mechanisms which result in:',
        options: [
      ...
      Question(
        question: 'The physiological effects of accelerations to the human body depend on:',
        options: [
      ...
      Question(
        question: 'A pressurized cabin helps to prevent:',
        options: [
      ...
      Question(
        question: 'Saturation of oxygen in the blood at sea level is approximately 98%. This saturation decreases with:',
        options: [
      ...
      Question(
        question: 'The severity of hypoxia depends on the:',
        options: [
      ...
      Question(
        question: 'Early symptoms of hypoxia could be:',
        options: [
          '1. euphoria',
      ...
      Question(
        question: 'Which of the following symptoms can indicate hypoxia?',
        options: [
      ...
      Question(
        question: 'During flight all crewmembers have one or more of the following symptoms:',
        options: [
          '1. blue lips',
      ...
      Question(
        question: 'Which measure(s) will help to compensate for hypoxia?',
        options: [
      ...
      Question(
        question: 'You can overcome hyperventilation by breathing into a plastic or paper bag.',
        options: [
          'The intention is:',
      ...
      Question(
        question: 'The proprioceptors do not orient an individual to his/her surroundings, but',
        options: [
          'informs him/her of',
      ...
      Question(
        question: 'Visual acuity during flight at high altitudes can be affected by:',
        options: [
          '1. anaemia',
      ...
      Question(
        question: 'Although we have a field of vision of more than 180° it is important during',
        options: [
      ...
      Question(
        question: 'When flying through a thunderstorm with lightning you can protect yourself from flashblindness by:',
        options: [
      ...
      Question(
        question: 'The inner ear is able to perceive:',
        options: [
      ...
      Question(
        question: 'Visual disturbances can be caused by:',
        options: [
          '1. hyperventilation',
          '2. hypoxia',
          '3. hypertension',
      ...
      Question(
        question: 'Disorientation is more likely to occur when the pilot is:',
        options: [
          '1. flying in IMC',
      ...
      Question(
        question: 'The \'Black hole\' phenomenon occurs during approaches at night and over',
        options: [
      ...
      Question(
        question: '1. In case of conflicting information you can always trust your Seat-of-the-Pants-Sense.',
        options: [
      ...
      Question(
        question: 'A passenger complains about a painful inflated belly at 8.000 feet. You advise him to:',
        options: [
      ...
      Question(
        question: 'Having a serious cold it is better not to fly, due to the extra risk of:',
        options: [
          '1. flatulence',
      ...
      Question(
        question: 'Tolerance to decompression sickness is decreased by:',
        options: [
          '1. SCUBA diving',
          '2. Obesity',
          '3. Age',
      ...
      Question(
        question: 'The following actions are appropriate when faced with symptoms of decompression sickness:',
        options: [
      ...
      Question(
        question: 'Decompression sickness can normally be prevented by:',
        options: [
      ...
      Question(
        question: 'CO (carbon monoxide) present in the smoke of cigarettes can lead to:',
        options: [
      ...
      Question(
        question: 'Carbon monoxide in the human body can lead to:',
        options: [
      ...
      Question(
        question: 'Disturbance of the biological clock appears after a:',
        options: [
          '1. bad night\'s sleep',
      ...
      Question(
        question: 'The effects of sleep deprivation on performance:',
        options: [
      ...
      Question(
        question: 'Sleeplessness or the disruption of sleeping patterns',
        options: [
      ...
      Question(
        question: 'The sleep cycles repeat during the course of a night\'s sleep.',
        options: [
      ...
      Question(
        question: 'The biological reaction to stress is identical regardless of the cause of stress.',
        options: [
      ...
      Question(
        question: 'According to the different phases of the \"General Adaptation Syndrome\" which of the following statement/s is/are correct?',
        options: [
      ...
      Question(
        question: 'Which of the following statements concerning stress are true ?',
        options: [
      ...
      Question(
        question: 'The ability to monitor information which could indicate the development of a',
        options: [
          'critical situation',
      ...
      Question(
        question: '1. Euphoria can be a symptom of hypoxia.',
        options: [
      ...
      Question(
        question: 'The circulation of blood:',
        options: [
      ...
      Question(
        question: 'The total gas volume of the lung is the sum of:',
        options: [
          '1. tidal volume',
      ...
      Question(
        question: 'Hypoxic hypoxia may be caused by:',
        options: [
      ...
      Question(
        question: 'The causes of human error can be abundant and complex. Which of the following factors could contribute to human error?',
        options: [
          '1. Personality.',
      ...
      Question(
        question: 'Organisational factors which affect or may have some influence on human error are:',
        options: [
      ...
      Question(
        question: 'Environmental sources of stress in the cockpit could be:',
        options: [
      ...
      Question(
        question: 'To prevent gastro-intestinal problems in tropical climates you should:',
        options: [
      ...
      Question(
        question: 'What factors can lead to a deterioration in vision?',
        options: [
          '1.  Hypoxia',
          '2.  Smoking',
      ...
      Question(
        question: 'The damaging effects of noise on the pilot depends on:',
        options: [
      ...
      Question(
        question: 'Waiting for takeoff on the runway, a pilot is informed by the tower that the tail wind component is 12 kt. According to the manual, the limitation is 10 kt max.',
        options: [
      ...
      Question(
        question: 'Haemoglobin has an affinity for carbon monoxide of ...............times over',
        options: [
          'oxygen',
          '210 - 250',
          '50 - 75',
      ...
      Question(
        question: 'Approximately ................... of all communication is achieved by factors other',
        options: [
