...
class AgkScreen extends StatefulWidget {
  const AgkScreen({super.key});

  @override
  State<AgkScreen> createState() => _AgkScreenState();
}

class _AgkScreenState extends State<AgkScreen> {
  List<Question> questions = AgkQuestions.getQuestions();
      ...
      if (currentQuestionIndex < questions.length - 1) {
        ...
        showDialog(
          ...
          builder: (context) => AlertDialog(
            ...
            content: Text(
              'You have completed all ${questions.length} AGK questions.\n\nWould you like to review again?',
