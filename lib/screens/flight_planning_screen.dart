...
class _FlightPlanningScreenState extends State<FlightPlanningScreen> {
  List<Question> questions = FlightPlanningQuestions.getQuestions();
      ...
      if (currentQuestionIndex < questions.length - 1) {
        ...
        showDialog(
          ...
          builder: (context) => AlertDialog(
            ...
            content: Text('You have completed all ${questions.length} Flight Planning questions.\n\nWould you like to review again?', style: const TextStyle(color: Colors.white70)),
            actions: [
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Flight Planning - Study Mode', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: Colors.white)),
