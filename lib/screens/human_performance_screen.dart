...
class HumanPerformanceScreen extends StatefulWidget {
  const HumanPerformanceScreen({super.key});

  @override
  State<HumanPerformanceScreen> createState() => _HumanPerformanceScreenState();
}

class _HumanPerformanceScreenState extends State<HumanPerformanceScreen> {
  List<Question> questions = HumanPerformanceQuestions.getQuestions();
      ...
      if (currentQuestionIndex < questions.length - 1) {
        ...
        showDialog(
          ...
          builder: (context) => AlertDialog(
            ...
            content: Text('You have completed all ${questions.length} Human Performance questions.\n\nWould you like to review again?', style: const TextStyle(color: Colors.white70)),
            actions: [
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Human Performance - Study Mode', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: Colors.white)),
