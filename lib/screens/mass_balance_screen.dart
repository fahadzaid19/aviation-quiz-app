...
class MassBalanceScreen extends StatefulWidget {
  const MassBalanceScreen({super.key});
...
class _MassBalanceScreenState extends State<MassBalanceScreen> {
  List<Question> questions = MassBalanceQuestions.getQuestions();
      ...
      if (currentQuestionIndex < questions.length - 1) {
        ...
        showDialog(
          ...
          builder: (context) => AlertDialog(
            ...
            content: Text('You have completed all ${questions.length} Mass and Balance questions.\n\nWould you like to review again?', style: const TextStyle(color: Colors.white70)),
            actions: [
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Mass and Balance - Study Mode', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: Colors.white)),
