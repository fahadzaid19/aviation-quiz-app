...
class OperationalProceduresScreen extends StatefulWidget {
  const OperationalProceduresScreen({super.key});

  @override
  State<OperationalProceduresScreen> createState() => _OperationalProceduresScreenState();
}

class _OperationalProceduresScreenState extends State<OperationalProceduresScreen> {
  List<Question> questions = OperationalProceduresQuestions.getQuestions();
      ...
      if (currentQuestionIndex < questions.length - 1) {
        ...
        showDialog(
          ...
          builder: (context) => AlertDialog(
            ...
            content: Text('You have completed all ${questions.length} Operational Procedures questions.\n\nWould you like to review again?', style: const TextStyle(color: Colors.white70)),
            actions: [
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Operational Procedures - Study Mode', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: Colors.white)),
